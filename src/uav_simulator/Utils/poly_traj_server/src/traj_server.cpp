...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber poly_sub = node.subscribe("trajectory", 1, polyTrajCallback);
  ros::Subscriber odom_sub = node.subscribe("odometry", 50, odomCallbck, ros::TransportHints().tcpNoDelay());
